    ...
    $.fn.timepicki = function (options) {
        ...
        return this.each(function () {
            ...
            var new_ele = $(
                ...
                "<div class='arrow_top'></div><div style='display:flex;'>" +
                "<div class='time'>" +
                top_arrow_button +
                ...
                bottom_arrow_button +
                "</div>" +
                (settings.show_meridian ? "<div class='meridian'>" + top_arrow_button + "<div class='mer_tx'><input type='text' class='timepicki-input' readonly></div>" + bottom_arrow_button + "</div>" : "")
            );
            ...
            $(".timepicki-input").keydown(function (keyevent) {
                ...
                function validate() {
                    ...
                    var isValidNumber = /^\d+$/.test(inputc);
            ...
            function change_time(cur_ele, direction) {
                ...
                if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next') {
                    if (cur_time + step_size > ele_en) {
                        ...
                        ele_next.find(".mins .mi_tx input").val(30);

                    } else {
                        cur_time = cur_time + step_size;
                        if (cur_time == 19) {
                            if (Number(ele_next.find(".mins .mi_tx input").val()) > 30) {
                    ...
                    if (cur_time - step_size < minValue) {
                        ...
                        if (cur_time == 6) {
                            if (Number(ele_next.find(".mins .mi_tx input").val()) < 30) {
                                ele_next.find("." + cur_cli + " .ti_tx input").val("0" + minValue);
                                ele_next.find(".mins .mi_tx input").val(30);
                            } else {
                                ele_next.find("." + cur_cli + " .ti_tx input").val("0" + minValue);
                            }
            ...
            function change_mins(cur_ele, direction) {
                ...
                var cur_hour = Number(ele_next.find(".time .ti_tx input").val());
                var ele_st = 0;
                var ele_en = 59;
                var step_size = Number(settings.step_size_minutes);
                if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next') {
                    if (Number(settings.max_hour_value) == cur_hour) {
                        if (cur_mins + step_size > 30) {
                            ele_next.find("." + cur_cli + " .mi_tx input").val("30");
                    ...
                    if (Number(settings.min_hour_value) == cur_hour) {
                        if (cur_mins - step_size < 30) {
